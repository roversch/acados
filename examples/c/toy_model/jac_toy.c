...
#else /* CODEGEN_PREFIX */
  #define CASADI_PREFIX(ID) jac_toy_ ## ID
...
/* jac_toy */
int jac_toy(const real_t** arg, real_t** res, int* iw, real_t* w, int mem) {
...
void jac_toy_incref(void) {
}

void jac_toy_decref(void) {
}

int jac_toy_n_in(void) { return 2;}

int jac_toy_n_out(void) { return 2;}

const char* jac_toy_name_in(int i){
  switch (i) {
  case 0: return "i0";
  case 1: return "i1";
  default: return 0;
...
const char* jac_toy_name_out(int i){
  switch (i) {
  case 0: return "o0";
  case 1: return "o1";
  default: return 0;
...
const int* jac_toy_sparsity_in(int i) {
  switch (i) {
  case 0: return s0;
  case 1: return s0;
  default: return 0;
...
const int* jac_toy_sparsity_out(int i) {
  switch (i) {
  case 0: return s0;
  case 1: return s0;
  default: return 0;
...
int jac_toy_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 2;
  if (sz_res) *sz_res = 2;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 5;
