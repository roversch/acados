...
#else /* CODEGEN_PREFIX */
  #define CASADI_PREFIX(ID) adj_toy_ ## ID
...
/* adj_toy */
int adj_toy(const real_t** arg, real_t** res, int* iw, real_t* w, int mem) {
  real_t a0=arg[0] ? arg[0][0] : 0;
  real_t a1=sq(a0);
  real_t a2=(a0*a1);
  a2=(a2+a2);
  real_t a3=arg[1] ? arg[1][0] : 0;
  a2=(a2*a3);
  a1=(a1*a2);
  real_t a4=(a0+a0);
  a0=(a0*a2);
...
void adj_toy_incref(void) {
}

void adj_toy_decref(void) {
}

int adj_toy_n_in(void) { return 3;}

int adj_toy_n_out(void) { return 1;}

const char* adj_toy_name_in(int i){
  switch (i) {
  case 0: return "i0";
  case 1: return "i1";
  case 2: return "i2";
...
const char* adj_toy_name_out(int i){
  switch (i) {
  case 0: return "o0";
  default: return 0;
  }
...
const int* adj_toy_sparsity_in(int i) {
  switch (i) {
  case 0: return s0;
  case 1: return s0;
  case 2: return s0;
...
const int* adj_toy_sparsity_out(int i) {
  switch (i) {
  case 0: return s1;
  default: return 0;
  }
...
int adj_toy_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 3;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 5;
