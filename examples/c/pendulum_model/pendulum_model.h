...
// explicit ODE
int pendulum_ode_expl_ode_fun(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
int pendulum_ode_expl_vde_forw(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
int pendulum_ode_expl_vde_adj(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
int pendulum_ode_expl_ode_jac(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
int pendulum_ode_expl_ode_jac_work(int *, int *, int *, int *);
const int *pendulum_ode_expl_ode_jac_sparsity_in(int);
const int *pendulum_ode_expl_ode_jac_sparsity_out(int);
int pendulum_ode_expl_ode_jac_n_in();
int pendulum_ode_expl_ode_jac_n_out();

// explicit adjoint ODE jac
int pendulum_ode_expl_ode_hess(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
// implicit ODE
int pendulum_ode_impl_ode_fun(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
// implicit ODE
int pendulum_ode_impl_ode_fun_jac_x_xdot(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
// implicit ODE
int pendulum_ode_impl_ode_jac_x_xdot_u(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
int pendulum_ode_impl_ode_fun_jac_x_xdot_u(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
...
int pendulum_ode_impl_ode_hess(const real_t** arg, real_t** res, int* iw, real_t* w, int mem);
